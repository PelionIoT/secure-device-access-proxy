...
// ----------------------------------------------------------------------------
package com.arm.mbed.aceauth.test.util;
...
import com.arm.mbed.aceauth.test.cose.KeyKeys;
import com.arm.mbed.aceauth.test.cose.OneKey;
import com.upokecenter.cbor.CBORObject;

public class EccCoseUtils {

    public static com.arm.mbed.aceauth.test.cose.OneKey convertEcKeyPairToOneKey(PublicKey pubKey, PrivateKey privKey) throws InvalidKeyException {

        AsymmetricKeyParameter privKeyParam = null;
        AsymmetricKeyParameter pubKeyParam = null;

        privKeyParam = generatePrivateKeyParameter(privKey);
        pubKeyParam = generatePublicKeyParameter(pubKey);
